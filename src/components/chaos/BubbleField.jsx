...
const BubbleField = ({ 
  ...
  // Bubble counter
  const BubbleCounter = () => (
    <div className="absolute top-4 right-4 bg-zinc-800/80 backdrop-blur-sm border border-zinc-700 rounded-xl px-4 py-2 z-30">
  ...
  return (
    <motion.div
      ref={containerRef}
      className="relative w-full h-full min-h-screen p-4 md:p-8 pb-40 md:pb-44"
