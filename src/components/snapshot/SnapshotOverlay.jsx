    ...
    <AnimatePresence>
      {showSnapshotOverlay && (
        <>
          ...
          {/* Overlay Panel */}
          <motion.div
            className="fixed top-0 left-0 right-0 z-[10000] max-h-[60vh] overflow-hidden"
          ...
          >
            <div className="bg-zinc-900/95 backdrop-blur-xl border-b border-orange-500/50 shadow-2xl">
              {/* Ambient glow effect */}
              <motion.div
              ...
              <div className="relative z-10 p-6 md:p-8 max-w-4xl mx-auto">
                ...
                <div className="flex items-center justify-between mb-6">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <h2 className="text-2xl lg:text-3xl font-bold text-orange-300">
                        Capture Thought
                      </h2>
                  ...
                  <div className="flex items-center gap-2">
                    <motion.button
                      ...
                      className="p-2 bg-zinc-800/80 hover:bg-zinc-700/80 border border-zinc-700/50 hover:border-orange-500/50 rounded-xl text-zinc-400 hover:text-orange-400 transition-all duration-300"
                    ...
                    <motion.button
                      onClick={handleClose}
                      className="p-2 bg-zinc-800/80 hover:bg-zinc-700/80 border border-zinc-700/50 hover:border-red-500/50 rounded-xl text-zinc-400 hover:text-red-400 transition-all duration-300"
                      whileHover={{ scale: 1.05 }}
                      whileTap={{ scale: 0.95 }}
                      title="Close"
                    >
                  ...
                  <div className="flex flex-wrap gap-2">
                    {tagOptions.map((tag) => (
                      ...
                      >
                        ...
                        <span className="text-sm hidden sm:inline">{tag.label}</span>
                      </button>
                    ))}
                  </div>
                </motion.div>
                ...
                >
                  <textarea
                    ...
                    className="w-full h-32 sm:h-40 bg-zinc-800/80 border border-zinc-700 hover:border-orange-500/50 focus:border-orange-500 rounded-2xl p-4 text-white placeholder-gray-500 focus:outline-none transition-all duration-300 resize-none text-base leading-relaxed"
                    style={{
                ...
                >
                  <motion.button
                    ...
                    className={`
                      flex-1 flex items-center justify-center gap-3 px-6 py-4 rounded-2xl font-semibold text-base transition-all duration-300
                  ...
                  <motion.button
                    onClick={handleClose}
                    className="px-6 py-4 bg-zinc-700 hover:bg-zinc-600 text-zinc-300 hover:text-white rounded-2xl font-medium transition-all duration-300"
                ...
                >
                  ...
                  <kbd className="px-2 py-1 bg-zinc-800 rounded text-xs ml-1">Enter</kbd> to forge • 
                  <kbd className="px-2 py-1 bg-zinc-800 rounded text-xs ml-1">Esc</kbd> to close
                </motion.div>
              </div>
            </div>
          </motion.div>
